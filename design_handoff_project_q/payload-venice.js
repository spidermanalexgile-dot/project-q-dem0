...
window.PAYLOAD_VENICE = {
  ...
  // The UI computes revenue from levers; these are informational anchors only.
  revenue_hint: { day: { peak_sat: 5000000 }, annual: 318000000 },

  phase: { year: 1, real_pay_cap: 20 },

  // Seasonal weighting for annual rollup. Days per year × demand %.
  seasonal: [
